...
"""autogenerated by genpy from AdaCt/cloud_info.msg. Do not edit."""
import codecs
import sys
...
class cloud_info(genpy.Message):
  _md5sum = "49d7e15d04cb07d4b59e4fdce8db7d1f"
  _type = "AdaCt/cloud_info"
...
string frame_id
"""
  __slots__ = ['header','timeStart','timeEnd','startRingIndex','endRingIndex','startOrientation','endOrientation','orientationDiff','segmentedCloudGroundFlag','segmentedCloudColInd','segmentedCloudRange']
  _slot_types = ['std_msgs/Header','float64','float64','int32[]','int32[]','float32','float32','float32','bool[]','uint32[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,timeStart,timeEnd,startRingIndex,endRingIndex,startOrientation,endOrientation,orientationDiff,segmentedCloudGroundFlag,segmentedCloudColInd,segmentedCloudRange
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2d().pack(_x.timeStart, _x.timeEnd))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timeStart, _x.timeEnd,) = _get_struct_2d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
