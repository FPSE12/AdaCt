...
class cloud_info {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.timeStart, buffer, bufferOffset);
    // Serialize message field [timeEnd]
    bufferOffset = _serializer.float64(obj.timeEnd, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.timeStart = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [timeEnd]
    data.timeEnd = _deserializer.float64(buffer, bufferOffset);
